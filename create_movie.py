...
def create_movie_connet():
    movie = readmovie()
    for i in movie:
        print(i)
        movieNode=MOVIEREL(uid=i[0],movie=i[1],year=i[5],rtAllCriticsRating=i[7],rtAllCriticsNumReviews=i[8],rtAudienceRating=i[17],rtAudienceNumRatings=i[18]).save()
        ...
        try:
            ...
            movieACTOR = select_movie_actor(str(i[0]))
            # print(movieACTOR)
            for j in movieACTOR:
                try:
        ...
        try:
            ...
            movieDIR=select_movie_directir(str(i[0]))
            # print(movieDIR[0][0])
        ...
        # 查出电影的所有的标签列表
        try:
            movie_tag_wight = select_movie_tags_wight(str(i[0]))
        ...
        try:
            ...
            movieDIR = select_genre_directir(str(i[0]))
            # print(movieDIR)
            for j in movieDIR:
                # print(j)
        ...
        try:
            ...
            movieCountry= select_countries_directir(str(i[0]))
            print(movieCountry)
